...
namespace Spotify.Exercise
{
    public class MediaPlayer
    {
        ...
        /*public void PlayRadio()
        {
            ...
            {
                currentRadio = DataStore.GetInstance().radios.Where(x => x.Genre.Name == currentSong.Genre.Name).FirstOrDefault();
            }
            List<Song> songs = DataStore.GetInstance().songs.Where(x=>x.Genre.Name == currentRadio.Genre.Name).ToList();

...
namespace Spotify.Exercise
{
    public class DataStore
    {
        ...
        DataStore()
        {
            ...
            #region csv
            songs = Utility.CreateObject<Song>(Utility.ReadfromFile(@"C:\Users\federico.cassera\Desktop\Spotify.csv"));
            /*try
            {
            ...
            foreach (Song s in songs)
            {
                //Utility.GetAlbumBySong(songs,albums);
                s.CreateAlbum(albums, songs);
            }
            foreach (Album album in albums)
            {
                //Utility.GetArtistByAlbum(albums);
                album.CreateArtist(artists, albums, songs);
            }
            /*try
            {
        ...
        /*public void ShowPlaylist()
        {
            ...
            foreach (var playlist in playlists)
            {
                Console.WriteLine($"Nome Playlist: {playlist.Name}  Autore: {playlist.Account.UserName}");
            }
        }*/
